...
const ACCENT_DEEP = '#0f766e';  // deeper teal for gradients
    ...
    <main className="w-full min-h-screen bg-[#16292C] px-4 md:px-6 py-8 relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <p className="font-sans text-sm text-white/60 mb-8">
          Secure checkout to publish your listing at <span className="text-white/80 font-semibold">zyphoriz.in</span>
        </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <div
              onClick={() => setPaymentMethod('upi')}
              className={`rounded-2xl p-5 cursor-pointer transition-all border backdrop-blur-sm ${
                paymentMethod === 'upi'
                  ? 'border-[#14b8a6] bg-[#14b8a6]/10 shadow-[0_0_0_1px_rgba(20,184,166,0.4),0_10px_30px_-12px_rgba(20,184,166,0.45)]'
              ...
              <div className="flex items-center gap-3 mb-3">
                <div
                  className={`w-5 h-5 rounded-full border-2 flex items-center justify-center flex-shrink-0 transition-colors ${
                    paymentMethod === 'upi' ? 'border-[#14b8a6]' : 'border-white/30'
                  }`}
                >
                  {paymentMethod === 'upi' && <div className="w-2.5 h-2.5 rounded-full bg-[#14b8a6]" />}
                </div>
                <Smartphone className="w-5 h-5 text-[#5eead4]" />
                <span className="font-sans font-semibold text-sm text-white">
                  UPI / PhonePe / GPay / Paytm
                </span>
              </div>
              {paymentMethod === 'upi' && (
                <p className="pl-8 text-xs text-white/60">
                  UPI details are entered securely in Razorpay Checkout.
                </p>
              )}
            </div>
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                <div
                  className={`w-5 h-5 rounded-full border-2 flex items-center justify-center flex-shrink-0 transition-colors ${
                    paymentMethod === 'card' ? 'border-[#14b8a6]' : 'border-white/30'
                  }`}
                >
                  {paymentMethod === 'card' && <div className="w-2.5 h-2.5 rounded-full bg-[#14b8a6]" />}
                </div>
              ...
              {paymentMethod === 'card' && (
                <p className="pl-8 text-xs text-white/60">
                  Card details are entered securely in Razorpay Checkout.
                </p>
              )}
            </div>
            ...
            <form onSubmit={handlePay}>
              <button
                type="submit"
                disabled={paying}
                className="w-full flex items-center justify-center gap-2.5 text-white font-sans font-bold py-4 rounded-xl transition-all text-base mt-2
          ...
          <div className="lg:col-span-2">
            <div className="bg-white/[0.04] border border-white/10 rounded-2xl p-6 space-y-4 sticky top-6 backdrop-blur-md shadow-[0_20px_50px_-20px_rgba(0,0,0,0.6)]">
              <h2 className="font-headline text-lg font-bold text-white">Order Summary</h2>
              ...
              {formData.slug && (
                <div className="bg-[#14b8a6]/10 border border-[#14b8a6]/30 rounded-xl px-4 py-3">
                  <p className="font-sans text-xs text-white/60 mb-0.5">Your business URL:</p>
              ...
              <div className="space-y-2 pt-1">
                {[
                  ...
                  <div key={item} className="flex items-start gap-2 font-sans text-xs text-white/70">
